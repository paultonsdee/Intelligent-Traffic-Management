...
from PyQt5.QtWidgets import (
    ...
    QWidget, QHBoxLayout, QVBoxLayout, QMessageBox, QSlider, QDialog,
    QCheckBox
)
...
class RegionSelectionWindow(QDialog):
    ...
    def accept(self):
        # Before closing, perhaps check that regions are set
        super().accept()
...
class TrafficLightWindow(QWidget):
    ...
    def setup_ui(self):
        ...
        layout.addWidget(self.label_timer, alignment=Qt.AlignCenter)
    ...
    def setup_timer(self):
        ...
        self.time_remaining = 30  # Bắt đầu từ đèn xanh
    ...
    def set_state(self, state):
        ...
        self.label_timer.setText(str(self.time_remaining))
...
class VideoThread(QThread):
    ...
    # Thêm tín hiệu để thông báo kết quả đếm xe
    cars_counted = pyqtSignal(int, str)  # số xe, loại đếm

    def __init__(self, video_file, speed_estimator, counter_region1, counter_region2, parent=None):
        super().__init__(parent)
        self.video_file = video_file
    ...
    # Thêm phương thức để cập nhật trạng thái đèn giao thông
                    ...
                    if self.counting:
                        ...
                        if self.traffic_light_state == 'green' and self.no_parking:
                            if elapsed <= self.count_duration:
                                ...
                                # Ví dụ: self.speed_estimator.get_car_speeds(frame)
                                # Và đếm số xe có vận tốc = 0
                                car_speeds = self.speed_estimator.get_car_speeds(frame, self.counter_region3)
...
class MainWindow(QMainWindow):
    ...
    def display_video(self, filepath):
        ...
        self.video_thread = VideoThread(filepath, self.speed_estimator, self.counter_region1, self.counter_region2)
